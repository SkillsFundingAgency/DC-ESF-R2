...
{
    public class ValidLearnerDataService1819 : IValidLearnerDataService1819
    {
        private readonly IValid1819Repository _validLearnerRepository;

        public ValidLearnerDataService1819(
            IValid1819Repository validLearnerRepository)
        {
