...
{
    public class Valid1819Repository : IValid1819Repository
    {
        private readonly Func<ILR1819ValidLearnerContext> _context;

        public Valid1819Repository(
            Func<ILR1819ValidLearnerContext> context)
        {
            _context = context;
        }
