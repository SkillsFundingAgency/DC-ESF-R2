...
{
    public class Fm701920Repository : IFm701920Repository
    {
        private readonly Func<ILR1920RulebaseContext> _rulebaseContext;
        private readonly Func<ILR1920ValidLearnerContext> _validContext;

        public Fm701920Repository(Func<ILR1920RulebaseContext> rulebaseContext, Func<ILR1920ValidLearnerContext> validContext)
        {
