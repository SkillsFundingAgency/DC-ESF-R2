...
namespace ESFA.DC.ESF.R2.ReportingService.AimAndDeliverable.Mapper._2021
{
    public class AimAndDeliverableMapper : AbstractAimAndDeliverableMapper
    {
        public AimAndDeliverableMapper()
        {
            ...
            Map(m => m.FcsDeliverableCodeMapping.Round2DeliverableName).Index(i++).Name("Deliverable name");
